(function (exports, ByteArray, global) {
  ...
  Protocol.strdecode = function(buffer) {
    if(typeof Buffer !== "undefined" && ByteArray === Buffer) {
      ...
      var s = "";
      while (l > 0) {
        // Limit it to short int, to avoid crash in cocos's js-binding.
        var limit = Math.min(32767, l);
        var pArr = array.splice(0, limit);
        s += String.fromCharCode.apply(null, pArr);
        l -= limit;
      }
      return s;
    }
